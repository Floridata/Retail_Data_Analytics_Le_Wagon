SELECT S.Store, ST.Type, Size_sqf, Size_sqm, Weekly_Sales, Weekly_Sales / Size_sqf AS Weekly_Sales_Size_Sqf, Weekly_Sales / Size_sqm AS Weekly_Sales_Size_Sqm, 
...
, Dept,	S.Date_date,  IsHoliday, Store_dept_date
